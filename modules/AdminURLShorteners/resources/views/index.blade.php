...
<div class="container max-w-800 pb-5">
    <form class="actionForm" action="{{ url_admin("settings/save") }}">
        ...
        <div class="card shadow-none border-gray-300 mb-4">
            <div class="card-header">
                <div class="fw-6">{{ __("Slimu.in") }}</div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-4">
                            ...
                            <div class="d-flex gap-8 flex-column flex-lg-row flex-md-column">
                                <div class="form-check me-3">
                                    <input class="form-check-input" type="radio" name="slimu_status" value="1" id="slimu_status_1" {{ get_option("slimu_status", 0)==1?"checked":"" }}>
                                    <label class="form-check-label mt-1" for="slimu_status_1">
                                        {{ __('Enable') }}
                                    </label>
                                </div>
                                <div class="form-check me-3">
                                    <input class="form-check-input" type="radio" name="slimu_status" value="0" id="slimu_status_0" {{ get_option("slimu_status", 0)==0?"checked":"" }}>
                    ...
                    <div class="col-md-12">
                        <div class="mb-4">
                            <label for="slimu_api_key" class="form-label">{{ __('API Key') }}</label>
                            <input class="form-control" name="slimu_api_key" id="slimu_api_key" type="text" value="{{ get_option("slimu_api_key", "") }}">
                        </div>
                    </div>
                </div>
            </div>
