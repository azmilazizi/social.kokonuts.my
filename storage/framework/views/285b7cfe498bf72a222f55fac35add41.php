...
<?php $component = App\View\Components\SubHeader::resolve(['title' => ''.e(__('Manage Support Types')).'','description' => ''.e(__('Support Types categorize and define assistance methods')).'','count' => $total] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/cotlas-socialxi/htdocs/socialxi.cotlas.net/modules/AdminSupportTypes/resources/views/index.blade.php ENDPATH**/ ?>