        ...
        <div class="d-flex align-items-center gap-8">
            ...
            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                <div class="flex-grow-1 me-2 text-truncate">
                    ...
                    <span class="text-gray-400 d-block fs-12"><?php echo e(date("M j")); ?></span>
                </div>
            </div>
        </div>
    ...
    <div class="mb-0">
        <div class="cpv-media mb-3">
            ...
            <div class="cpv-instagram-img-view wp-100">
                <img src="<?php echo e(theme_public_asset( "img/default.png" )); ?>" class="wp-100">
            </div>
        </div>
...
<?php /**PATH /var/www/social.kokonuts.my/modules/AppChannelInstagramProfiles/resources/views/preview.blade.php ENDPATH**/ ?>