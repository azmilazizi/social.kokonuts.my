...
<?php $component = App\View\Components\SubHeader::resolve(['title' => ''.e(__('Payment Manual')).'','description' => ''.e(__('Show manual payment amounts and transaction details')).'','count' => $total] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
        <a class="btn btn-dark btn-sm actionItem" href="<?php echo e(module_url('update')); ?>"  data-popup="AdminManualPaymentsModal">
...
<?php $__env->startSection('script'); ?>
    <?php $__env->startComponent('components.datatable_script', [ "Datatable" => $Datatable, "edit_popup" => "AdminManualPaymentsModal" , "column_actions" => true, "column_status" => true]); ?> <?php echo $__env->renderComponent(); ?>
                            ...
                            <div class="text-start lh-1 text-truncate">
                                <div class="fw-5 text-gray-900 text-truncate">
                                    <div class="text-truncate">
                                        <a class="text-gray-800 text-hover-primary actionItem" data-id="${row.id_secure}" href="<?php echo e(module_url("update")); ?>" data-popup="AdminManualPaymentsModal">
                                            ${row.user_fullname}
                                        </a>
                                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/cotlas-socialxi/htdocs/socialxi.cotlas.net/modules/AdminManualPayments/resources/views/index.blade.php ENDPATH**/ ?>