<div class="modal fade" id="supportTypeModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
		<form class="modal-content actionForm" action="<?php echo e(module_url("save")); ?>" data-call-success="Main.closeModal('supportTypeModal'); Main.ajaxScroll(true);">
			<div class="modal-header">
				<h1 class="modal-title fs-16"><?php echo e(__("Create Type")); ?></h1>
 				...
 				<div class="row">
 					...
 					<div class="col-md-12">
 						<div class="mb-4">
	                     	...
	                     	<input placeholder="<?php echo e(__('Enter Type Name')); ?>" class="form-control" name="name" id="name" type="text" value="<?php echo e(data($result, "name")); ?>">
		                </div>
 					</div>
 					<div class="col-md-12">
 						<div class="mb-4">
...
<?php /**PATH /home/cotlas-socialxi/htdocs/socialxi.cotlas.net/modules/AdminSupportTypes/resources/views/update.blade.php ENDPATH**/ ?>