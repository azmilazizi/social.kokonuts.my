                ...
                <div class="d-none">
                    ...
                    <div class="preview-list-medias">
                        <?php $__currentLoopData = $medias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <?php if($isVideo): ?>
                                <video data-preview-media data-type="video" data-file="<?php echo e($mediaUrl); ?>" src="<?php echo e($mediaUrl); ?>" playsinline></video>
                            <?php else: ?>
                                <img data-preview-media data-type="image" data-file="<?php echo e($mediaUrl); ?>" src="<?php echo e($mediaUrl); ?>">
                            <?php endif; ?>
...
<?php /**PATH /var/www/social.kokonuts.my/modules/AppPublishing/resources/views/preview.blade.php ENDPATH**/ ?>