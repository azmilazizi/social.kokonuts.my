<section class="min-h-screen bg-gray-100 flex items-center justify-center px-4 py-16">
    <div class="w-full max-w-md text-center">
        ...
        <div class="mt-8 flex items-center justify-center text-sm text-gray-500">
            <a href="<?php echo e(url('terms-of-service')); ?>" class="font-medium text-gray-600 hover:text-gray-800">
                <?php echo e(__("Terms of Service")); ?>

            </a>
            <span class="mx-3 h-4 w-px bg-gray-300" aria-hidden="true"></span>
            <a href="<?php echo e(url('privacy-policy')); ?>" class="font-medium text-gray-600 hover:text-gray-800">
