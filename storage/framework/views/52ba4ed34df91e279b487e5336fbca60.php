    ...
    <div class="w-full max-w-md text-center">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 text-left">
            <form class="actionForm w-full" action="<?php echo e(module_url('do_login')); ?>" method="POST">
                ...
                <button type="submit" class="mb-6 py-3.5 px-6 w-full text-white font-semibold rounded-xl shadow-sm focus:ring focus:ring-gray-300 bg-slate-900 hover:bg-slate-800 transition ease-in-out duration-200">
                    <?php echo e(__("Login")); ?>
