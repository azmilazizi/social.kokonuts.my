...
<?php $component = App\View\Components\SubHeader::resolve(['title' => ''.e(__('Support Categories')).'','description' => ''.e(__('Organize and manage support topics systematically for efficiency')).'','count' => Number::format($total)] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
        <div class="d-flex gap-8">
            <a class="btn btn-dark btn-sm actionItem text-nowrap" href="<?php echo e(module_url("update")); ?>" data-popup="supportCategoryModal" data-bs-target="#staticBackdrop">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/cotlas-socialxi/htdocs/socialxi.cotlas.net/modules/AdminSupportCategories/resources/views/index.blade.php ENDPATH**/ ?>