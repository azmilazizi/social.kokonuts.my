	    		...
	    		<div class="d-flex gap-16">
	    			<div class="btn-group position-static">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end border-1 border-gray-300 px-1 w-100 max-w-120 min-w-120">
                            <li>
                                <a class="dropdown-item px-2 p-t-2 p-b-2 rounded d-flex align-items-center gap-8 fw-5 fs-13 actionItem" href="<?php echo e(module_url("update")); ?>" data-id="<?php echo e($value->id_secure); ?>" data-popup="SupportLabelsModal" data-call-success="">
...
<?php else: ?>
	<div class="empty"></div>
<?php endif; ?><?php /**PATH /home/cotlas-socialxi/htdocs/socialxi.cotlas.net/modules/AdminSupportLabels/resources/views/list.blade.php ENDPATH**/ ?>