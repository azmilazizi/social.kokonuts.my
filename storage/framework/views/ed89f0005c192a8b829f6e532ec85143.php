<div class="modal fade" id="supportCategoryModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
		<form class="modal-content actionForm" action="<?php echo e(module_url("save")); ?>" data-call-success="Main.closeModal('supportCategoryModal'); Main.ajaxScroll(true);">
			<div class="modal-header">
				<h1 class="modal-title fs-16"><?php echo e(__("Create Categories")); ?></h1>
 				...
 				<div class="row">
 					...
 					<div class="col-md-12">
 						<div class="mb-4">
	                     	...
	                     	<input placeholder="<?php echo e(__('Enter Category Name')); ?>" class="form-control" name="name" id="name" type="text" value="<?php echo e(data($result, "name")); ?>">
		                </div>
 					</div>
 					<div class="col-md-12">
 						<div class="mb-4">
		                  	<label for="name" class="form-label"><?php echo e(__('Icon')); ?></label>
		                  	<div class="text-gray-600 fs-12 mb-2"><?php echo e(__("You can find icon at here: ")); ?><a href="https://fontawesome.com/v5/search" target="_blank">https://fontawesome.com/v5/search</a></div>
	                     	<input placeholder="<?php echo e(__('Enter Font Awesome Icon')); ?>" class="form-control" name="icon" id="icon" type="text" value="<?php echo e(data($result, "icon")); ?>">
		                </div>
 					</div>
 					<div class="col-md-12">
 						<div class="mb-0">
...
<?php /**PATH /home/cotlas-socialxi/htdocs/socialxi.cotlas.net/modules/AdminSupportCategories/resources/views/update.blade.php ENDPATH**/ ?>