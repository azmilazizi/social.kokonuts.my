<div class="youtube-preview border border-gray-400 rounded bg-white">
        ...
        <div class="d-flex align-items-center gap-8">
            ...
            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                <div class="flex-grow-1 me-2 text-truncate">
                    ...
                    <span class="text-muted fw-semibold d-block fs-12"><?php echo e(__("YouTube")); ?></span>
                </div>
            </div>
        </div>
        <span class="badge bg-dark text-white cpv-youtube-badge"><?php echo e(__("Shorts")); ?></span>
    </div>
    ...
    <div class="px-3 pb-3 d-flex justify-content-between text-gray-800 align-items-center">
        ...
        <div class="d-flex align-items-center gap-6">
            ...
            <span class="fs-12 text-gray-600"><?php echo e(__("More")); ?></span>
        </div>
    </div>
</div>
...
</script><?php /**PATH /var/www/social.kokonuts.my/modules/AppChannelYoutubeProfiles/resources/views/preview.blade.php ENDPATH**/ ?>