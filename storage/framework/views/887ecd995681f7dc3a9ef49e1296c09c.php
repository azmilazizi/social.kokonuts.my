...
<?php $component = App\View\Components\SubHeader::resolve(['title' => ''.e(__('Help Center')).'','description' => ''.e(__('Find answers or submit requests for support easily')).'','count' => $total] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
            ...
            "columnDefs": [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        var read = '';
                        if(row.user_read){
                            read = `<span class="badge badge-outline badge-xs badge-danger b-r-20 ml-4 px-2"><?php echo e(__("Unread")); ?><i class="ps-1 fa-light fa-envelope"></i></span>`;
                        }
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        if (row.status == 1) {
                            return `
                                <a href="<?php echo e(module_url("resolved")); ?>" data-id="${row.id_secure}" class="btn btn-icon btn-success btn-sm b-r-50 actionItem" type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="<?php echo e(__("Resolved")); ?>"  data-call-success="Main.DataTable_Reload('#<?php echo e($Datatable['element']); ?>')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/cotlas-socialxi/htdocs/socialxi.cotlas.net/modules/AppSupport/resources/views/index.blade.php ENDPATH**/ ?>