...
<script>
	var incomeChart = <?php echo json_encode($incomeChart); ?>;
    ...
    Main.Chart('column', incomeChart.series, 'income-by-day-chart', {
   	...
   	var gatewayChart = <?php echo json_encode($gatewayChart); ?>;
	...
	var planChartSeries = <?php echo json_encode($planChartSeries); ?>;
	var planNames = <?php echo json_encode($planNames); ?>;
...
</script><?php /**PATH /home/cotlas-socialxi/htdocs/socialxi.cotlas.net/modules/AdminPaymentReport/resources/views/statistics.blade.php ENDPATH**/ ?>