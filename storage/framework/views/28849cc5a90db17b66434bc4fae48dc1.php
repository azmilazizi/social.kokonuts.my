<div class="offcanvas offcanvas-end border-start" data-bs-backdrop="false" tabindex="-1" id="getCaptionOffCanvas">
    <div class="offcanvas-header border-bottom pt-23 pb-22">
        <div class="fw-5"><?php echo e(__("List caption")); ?></div>
        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body p-0">
        <form method="POST">
            <div class="ajax-scroll-9" data-url="<?php echo e(route("app.captions.popup_list")); ?>" data-resp=".caption-list" data-scroll=".offcanvas-body">
...
</script><?php /**PATH /var/www/social.kokonuts.my/modules/AppCaptions/resources/views/get_caption.blade.php ENDPATH**/ ?>